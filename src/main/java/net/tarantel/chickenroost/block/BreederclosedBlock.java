...
public class BreederclosedBlock extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;

	public BreederclosedBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(ChickenRoostModBlocks.BREEDERCLOSED.get(), renderType -> renderType == RenderType.cutout());
	}
}
