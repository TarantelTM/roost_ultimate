...
public class BreederBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public BreederBlockEntity(BlockPos position, BlockState state) {
		super(ChickenRoostModBlockEntities.BREEDER.get(), position, state);
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new BreederguiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
