...
public class AChickenClayEntity extends Chicken {
	public AChickenClayEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_CLAY.get(), world);
	}

	public AChickenClayEntity(EntityType<AChickenClayEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Clay Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Items.CLAY_BALL));
	}
