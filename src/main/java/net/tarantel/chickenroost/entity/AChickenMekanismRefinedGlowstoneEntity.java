...
public class AChickenMekanismRefinedGlowstoneEntity extends Chicken {
	public AChickenMekanismRefinedGlowstoneEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_MEKANISM_REFINED_GLOWSTONE.get(), world);
	}

	public AChickenMekanismRefinedGlowstoneEntity(EntityType<AChickenMekanismRefinedGlowstoneEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Refined Glowstone Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.REFINED_GLOWSTONE_NUGGET.get()));
	}
