...
public class AChickenInkEntity extends Chicken {
	public AChickenInkEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_INK.get(), world);
	}

	public AChickenInkEntity(EntityType<AChickenInkEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Ink Chicken"));
