...
public class AChickennetheriteEntity extends Chicken {
	public AChickennetheriteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKENNETHERITE.get(), world);
	}

	public AChickennetheriteEntity(EntityType<AChickennetheriteEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Netherite Chicken"));
