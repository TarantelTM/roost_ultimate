...
public class AChickenMekanismLeadEntity extends Chicken {
	public AChickenMekanismLeadEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_MEKANISM_LEAD.get(), world);
	}

	public AChickenMekanismLeadEntity(EntityType<AChickenMekanismLeadEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Lead Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.LEAD_NUGGET.get()));
	}
