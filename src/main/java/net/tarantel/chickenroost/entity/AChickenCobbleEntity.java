...
public class AChickenCobbleEntity extends Chicken {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.CREATURE)
				.add(new MobSpawnSettings.SpawnerData(ChickenRoostModEntities.A_CHICKEN_COBBLE.get(), 15, 1, 2));
	}

	public AChickenCobbleEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_COBBLE.get(), world);
	}
	...
	public AChickenCobbleEntity(EntityType<AChickenCobbleEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Cobble Chicken"));
	...
	public static void init() {
		SpawnPlacements.register(ChickenRoostModEntities.A_CHICKEN_COBBLE.get(), SpawnPlacements.Type.ON_GROUND,
