...
public class AChickenglowberriesEntity extends Chicken {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.CREATURE)
				.add(new MobSpawnSettings.SpawnerData(ChickenRoostModEntities.A_CHICKENGLOWBERRIES.get(), 8, 1, 2));
	}

	public AChickenglowberriesEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKENGLOWBERRIES.get(), world);
	}
	...
	public AChickenglowberriesEntity(EntityType<AChickenglowberriesEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Glow Berries Chicken"));
	...
	public static void init() {
		SpawnPlacements.register(ChickenRoostModEntities.A_CHICKENGLOWBERRIES.get(), SpawnPlacements.Type.ON_GROUND,
