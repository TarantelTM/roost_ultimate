...
public class AChickenSoulSandEntity extends Chicken {
	public AChickenSoulSandEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_SOUL_SAND.get(), world);
	}

	public AChickenSoulSandEntity(EntityType<AChickenSoulSandEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Soul Sand Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.SOUL_SAND));
	}
