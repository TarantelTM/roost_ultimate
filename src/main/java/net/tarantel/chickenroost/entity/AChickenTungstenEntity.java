...
public class AChickenTungstenEntity extends Chicken {
	public AChickenTungstenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_TUNGSTEN.get(), world);
	}

	public AChickenTungstenEntity(EntityType<AChickenTungstenEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Tungsten Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.TUNGSTEN_NUGGET.get()));
	}
