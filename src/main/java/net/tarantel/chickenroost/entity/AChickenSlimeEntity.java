...
public class AChickenSlimeEntity extends Chicken {
	public AChickenSlimeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_SLIME.get(), world);
	}

	public AChickenSlimeEntity(EntityType<AChickenSlimeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Slime Chicken"));
