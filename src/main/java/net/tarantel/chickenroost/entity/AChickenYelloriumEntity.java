...
public class AChickenYelloriumEntity extends Chicken {
	public AChickenYelloriumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_YELLORIUM.get(), world);
	}

	public AChickenYelloriumEntity(EntityType<AChickenYelloriumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Yellorium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.YELLORIUM_NUGGET.get()));
	}
