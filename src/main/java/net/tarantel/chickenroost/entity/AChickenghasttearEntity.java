...
public class AChickenghasttearEntity extends Chicken {
	public AChickenghasttearEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKENGHASTTEAR.get(), world);
	}

	public AChickenghasttearEntity(EntityType<AChickenghasttearEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Ghast Tear Chicken"));
