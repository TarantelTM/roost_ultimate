...
public class AChickenMekanismBronzeEntity extends Chicken {
	public AChickenMekanismBronzeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_MEKANISM_BRONZE.get(), world);
	}

	public AChickenMekanismBronzeEntity(EntityType<AChickenMekanismBronzeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Bronze Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.BRONZE.get()));
	}
