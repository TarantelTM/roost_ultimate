...
public class AChickenOsmiumEntity extends Chicken {
	public AChickenOsmiumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_OSMIUM.get(), world);
	}
	...
	public AChickenOsmiumEntity(EntityType<AChickenOsmiumEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Osmium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.OSMIUMNUGGET.get()));
	}
