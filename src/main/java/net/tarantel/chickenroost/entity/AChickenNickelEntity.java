...
public class AChickenNickelEntity extends Chicken {
	public AChickenNickelEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_NICKEL.get(), world);
	}

	public AChickenNickelEntity(EntityType<AChickenNickelEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Nickel Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.NICKEL_NUGGET.get()));
	}
