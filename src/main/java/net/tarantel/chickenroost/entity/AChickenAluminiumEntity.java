...
public class AChickenAluminiumEntity extends Chicken {
	public AChickenAluminiumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_ALUMINIUM.get(), world);
	}

	public AChickenAluminiumEntity(EntityType<AChickenAluminiumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Aluminium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.ALUMINIUM.get()));
	}
