...
public class AChickenIridiumEntity extends Chicken {
	public AChickenIridiumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_IRIDIUM.get(), world);
	}

	public AChickenIridiumEntity(EntityType<AChickenIridiumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Iridium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.IRIDIUM_NUGGET.get()));
	}
