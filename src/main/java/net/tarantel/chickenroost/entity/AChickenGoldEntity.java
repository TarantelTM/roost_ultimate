...
public class AChickenGoldEntity extends Chicken {
	public AChickenGoldEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_GOLD.get(), world);
	}

	public AChickenGoldEntity(EntityType<AChickenGoldEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Gold Chicken"));
