...
public class AChickenRefinedironEntity extends Chicken {
	public AChickenRefinedironEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_REFINEDIRON.get(), world);
	}

	public AChickenRefinedironEntity(EntityType<AChickenRefinedironEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Refined Iron Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.REFINED_IRON_NUGGET.get()));
	}
