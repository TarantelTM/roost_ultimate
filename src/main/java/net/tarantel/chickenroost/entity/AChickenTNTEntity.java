...
public class AChickenTNTEntity extends Chicken {
	public AChickenTNTEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_TNT.get(), world);
	}

	public AChickenTNTEntity(EntityType<AChickenTNTEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("TNT Chicken"));
