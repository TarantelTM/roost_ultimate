...
public class AChickenDioriteEntity extends Chicken {
	public AChickenDioriteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_DIORITE.get(), world);
	}

	public AChickenDioriteEntity(EntityType<AChickenDioriteEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Diorite Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.DIORITE));
	}
