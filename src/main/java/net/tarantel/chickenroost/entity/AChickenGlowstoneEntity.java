...
public class AChickenGlowstoneEntity extends Chicken {
	public AChickenGlowstoneEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_GLOWSTONE.get(), world);
	}

	public AChickenGlowstoneEntity(EntityType<AChickenGlowstoneEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Glowstone Chicken"));
