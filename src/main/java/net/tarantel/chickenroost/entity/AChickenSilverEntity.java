...
public class AChickenSilverEntity extends Chicken {
	public AChickenSilverEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_SILVER.get(), world);
	}

	public AChickenSilverEntity(EntityType<AChickenSilverEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Silver Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.SILVER_NUGGET.get()));
	}
