...
public class AChickenPlatinumEntity extends Chicken {
	public AChickenPlatinumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_PLATINUM.get(), world);
	}

	public AChickenPlatinumEntity(EntityType<AChickenPlatinumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Platinum Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.PLATINUM_NUGGET.get()));
	}
