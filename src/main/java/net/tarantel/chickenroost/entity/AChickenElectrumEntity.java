...
public class AChickenElectrumEntity extends Chicken {
	public AChickenElectrumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_ELECTRUM.get(), world);
	}
	...
	public AChickenElectrumEntity(EntityType<AChickenElectrumEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Electrum Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.ELECTRUM.get()));
	}
