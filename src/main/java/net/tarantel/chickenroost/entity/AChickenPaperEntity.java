...
public class AChickenPaperEntity extends Chicken {
	public AChickenPaperEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_PAPER.get(), world);
	}

	public AChickenPaperEntity(EntityType<AChickenPaperEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Paper Chicken"));
