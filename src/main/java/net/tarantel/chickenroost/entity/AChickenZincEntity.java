...
public class AChickenZincEntity extends Chicken {
	public AChickenZincEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_ZINC.get(), world);
	}

	public AChickenZincEntity(EntityType<AChickenZincEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Zinc Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.ZINC_NUGGET.get()));
	}
