...
public class AChickenbeetrootEntity extends Chicken {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.CREATURE)
				.add(new MobSpawnSettings.SpawnerData(ChickenRoostModEntities.A_CHICKENBEETROOT.get(), 8, 1, 2));
	}

	public AChickenbeetrootEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKENBEETROOT.get(), world);
	}
	...
	public AChickenbeetrootEntity(EntityType<AChickenbeetrootEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Beetroot Chicken"));
	...
	public static void init() {
		SpawnPlacements.register(ChickenRoostModEntities.A_CHICKENBEETROOT.get(), SpawnPlacements.Type.ON_GROUND,
