...
public class AChickenAndersiteEntity extends Chicken {
	public AChickenAndersiteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_ANDERSITE.get(), world);
	}

	public AChickenAndersiteEntity(EntityType<AChickenAndersiteEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Andesite Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.ANDESITE));
	}
