...
public class AChickenUnobtainiumEntity extends Chicken {
	public AChickenUnobtainiumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_UNOBTAINIUM.get(), world);
	}
	...
	public AChickenUnobtainiumEntity(EntityType<AChickenUnobtainiumEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Unobtainium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.UNOBTAINIUM_NUGGET.get()));
	}
