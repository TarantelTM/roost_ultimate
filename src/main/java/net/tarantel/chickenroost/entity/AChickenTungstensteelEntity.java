...
public class AChickenTungstensteelEntity extends Chicken {
	public AChickenTungstensteelEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_TUNGSTENSTEEL.get(), world);
	}

	public AChickenTungstensteelEntity(EntityType<AChickenTungstensteelEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Tungsten Steel Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.TUNGSTENSTEEL_NUGGET.get()));
	}
