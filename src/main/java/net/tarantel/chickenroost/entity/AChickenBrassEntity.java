...
public class AChickenBrassEntity extends Chicken {
	public AChickenBrassEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_BRASS.get(), world);
	}

	public AChickenBrassEntity(EntityType<AChickenBrassEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Brass Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.BRASS.get()));
	}
