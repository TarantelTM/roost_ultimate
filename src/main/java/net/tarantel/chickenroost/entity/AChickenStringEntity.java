...
public class AChickenStringEntity extends Chicken {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(ChickenRoostModEntities.A_CHICKEN_STRING.get(), 8, 1, 2));
	}

	public AChickenStringEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_STRING.get(), world);
	}
	...
	public AChickenStringEntity(EntityType<AChickenStringEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("String Chicken"));
	...
	public static void init() {
		SpawnPlacements.register(ChickenRoostModEntities.A_CHICKEN_STRING.get(), SpawnPlacements.Type.ON_GROUND,
