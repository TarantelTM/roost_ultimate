...
public class AChickenDiamondEntity extends Chicken {
	public AChickenDiamondEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_DIAMOND.get(), world);
	}

	public AChickenDiamondEntity(EntityType<AChickenDiamondEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Diamond Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.DIAMONDNUGGET.get()));
	}
