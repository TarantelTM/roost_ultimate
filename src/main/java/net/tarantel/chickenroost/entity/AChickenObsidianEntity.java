...
public class AChickenObsidianEntity extends Chicken {
	public AChickenObsidianEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_OBSIDIAN.get(), world);
	}

	public AChickenObsidianEntity(EntityType<AChickenObsidianEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Obsidian Chicken"));
