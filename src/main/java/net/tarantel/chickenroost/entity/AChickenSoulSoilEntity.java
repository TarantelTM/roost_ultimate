...
public class AChickenSoulSoilEntity extends Chicken {
	public AChickenSoulSoilEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_SOUL_SOIL.get(), world);
	}

	public AChickenSoulSoilEntity(EntityType<AChickenSoulSoilEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Soul Soil Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.SOUL_SOIL));
	}
