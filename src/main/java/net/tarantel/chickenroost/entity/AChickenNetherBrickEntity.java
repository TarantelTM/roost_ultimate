...
public class AChickenNetherBrickEntity extends Chicken {
	public AChickenNetherBrickEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_NETHER_BRICK.get(), world);
	}

	public AChickenNetherBrickEntity(EntityType<AChickenNetherBrickEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Nether Brick Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Items.NETHER_BRICK));
	}
