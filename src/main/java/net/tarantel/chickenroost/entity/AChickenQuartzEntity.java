...
public class AChickenQuartzEntity extends Chicken {
	public AChickenQuartzEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_QUARTZ.get(), world);
	}

	public AChickenQuartzEntity(EntityType<AChickenQuartzEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Netherquartz Chicken"));
