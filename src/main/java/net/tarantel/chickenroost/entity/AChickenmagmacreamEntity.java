...
public class AChickenmagmacreamEntity extends Chicken {
	public AChickenmagmacreamEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKENMAGMACREAM.get(), world);
	}

	public AChickenmagmacreamEntity(EntityType<AChickenmagmacreamEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Magma Cream Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Items.MAGMA_CREAM));
	}
