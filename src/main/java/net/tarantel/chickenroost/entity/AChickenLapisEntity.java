...
public class AChickenLapisEntity extends Chicken {
	public AChickenLapisEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_LAPIS.get(), world);
	}

	public AChickenLapisEntity(EntityType<AChickenLapisEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Lapis Chicken"));
