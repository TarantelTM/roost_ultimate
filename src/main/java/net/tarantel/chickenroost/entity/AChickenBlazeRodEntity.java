...
public class AChickenBlazeRodEntity extends Chicken {
	public AChickenBlazeRodEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_BLAZE_ROD.get(), world);
	}

	public AChickenBlazeRodEntity(EntityType<AChickenBlazeRodEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Blaze Rod Chicken"));
