...
public class AChickenMekanismUraniumEntity extends Chicken {
	public AChickenMekanismUraniumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_MEKANISM_URANIUM.get(), world);
	}

	public AChickenMekanismUraniumEntity(EntityType<AChickenMekanismUraniumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Uranium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.URANIUM_NUGGET.get()));
	}
