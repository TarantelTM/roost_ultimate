...
public class AChickenCharCoalEntity extends Chicken {
	public AChickenCharCoalEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_CHAR_COAL.get(), world);
	}

	public AChickenCharCoalEntity(EntityType<AChickenCharCoalEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Charcoal Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Items.CHARCOAL));
	}
