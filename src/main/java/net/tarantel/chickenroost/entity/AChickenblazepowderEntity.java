...
public class AChickenblazepowderEntity extends Chicken {
	public AChickenblazepowderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKENBLAZEPOWDER.get(), world);
	}

	public AChickenblazepowderEntity(EntityType<AChickenblazepowderEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Blaze Powder Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Items.BLAZE_POWDER));
	}
