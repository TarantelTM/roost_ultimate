...
public class AChickenMekanismRefinedObsiEntity extends Chicken {
	public AChickenMekanismRefinedObsiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_MEKANISM_REFINED_OBSI.get(), world);
	}

	public AChickenMekanismRefinedObsiEntity(EntityType<AChickenMekanismRefinedObsiEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Refined Obsidian Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.REFINED_OBSIDIAN_NUGGET.get()));
	}
