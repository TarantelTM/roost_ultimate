...
public class AChickenCopperEntity extends Chicken {
	public AChickenCopperEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_COPPER.get(), world);
	}

	public AChickenCopperEntity(EntityType<AChickenCopperEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Copper Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.COPPERNUGGET.get()));
	}
