...
public class AChickenEnderEyeEntity extends Chicken {
	public AChickenEnderEyeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_ENDER_EYE.get(), world);
	}

	public AChickenEnderEyeEntity(EntityType<AChickenEnderEyeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Eye of Ender Chicken"));
