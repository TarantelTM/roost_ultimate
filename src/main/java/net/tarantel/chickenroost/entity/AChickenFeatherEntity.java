...
public class AChickenFeatherEntity extends Chicken {
	public AChickenFeatherEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_FEATHER.get(), world);
	}

	public AChickenFeatherEntity(EntityType<AChickenFeatherEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Feather Chicken"));
