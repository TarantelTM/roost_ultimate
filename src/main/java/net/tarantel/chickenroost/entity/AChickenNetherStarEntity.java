...
public class AChickenNetherStarEntity extends Chicken {
	public AChickenNetherStarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_NETHER_STAR.get(), world);
	}

	public AChickenNetherStarEntity(EntityType<AChickenNetherStarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Nether Star Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.NETHERSTARSHARD.get()));
	}
