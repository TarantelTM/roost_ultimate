...
public class AChickenBotaniaElementiumEntity extends Chicken {
	public AChickenBotaniaElementiumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_BOTANIA_ELEMENTIUM.get(), world);
	}
	...
	public AChickenBotaniaElementiumEntity(EntityType<AChickenBotaniaElementiumEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Elementium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.ELEMENTIUM_NUGGET.get()));
	}
