...
public class AChickenAllthemodiumEntity extends Chicken {
	public AChickenAllthemodiumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_ALLTHEMODIUM.get(), world);
	}
	...
	public AChickenAllthemodiumEntity(EntityType<AChickenAllthemodiumEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Allthemodium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.ALLTHEMODIUM.get()));
	}
