...
public class AChickenMekanismTinEntity extends Chicken {
	public AChickenMekanismTinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_MEKANISM_TIN.get(), world);
	}

	public AChickenMekanismTinEntity(EntityType<AChickenMekanismTinEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Tin Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.TIN_NUGGET.get()));
	}
