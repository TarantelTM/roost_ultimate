...
public class AChickenAdamantiumEntity extends Chicken {
	public AChickenAdamantiumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_ADAMANTIUM.get(), world);
	}

	public AChickenAdamantiumEntity(EntityType<AChickenAdamantiumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Adamantium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.ADAMANTIUM.get()));
	}
