...
public class AChickenTitaniumEntity extends Chicken {
	public AChickenTitaniumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_TITANIUM.get(), world);
	}

	public AChickenTitaniumEntity(EntityType<AChickenTitaniumEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Titanium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.TITANIUM_NUGGET.get()));
	}
