...
public class AChickenInvarEntity extends Chicken {
	public AChickenInvarEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_INVAR.get(), world);
	}

	public AChickenInvarEntity(EntityType<AChickenInvarEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Invar Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.INVAR_NUGGET.get()));
	}
