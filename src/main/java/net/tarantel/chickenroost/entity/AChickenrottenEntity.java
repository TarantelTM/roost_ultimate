...
public class AChickenrottenEntity extends Chicken {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(ChickenRoostModEntities.A_CHICKENROTTEN.get(), 8, 1, 2));
	}

	public AChickenrottenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKENROTTEN.get(), world);
	}
	...
	public AChickenrottenEntity(EntityType<AChickenrottenEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Rotten Chicken"));
	...
	public static void init() {
		SpawnPlacements.register(ChickenRoostModEntities.A_CHICKENROTTEN.get(), SpawnPlacements.Type.ON_GROUND,
