...
public class AChickenMekanismSteelEntity extends Chicken {
	public AChickenMekanismSteelEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_MEKANISM_STEEL.get(), world);
	}

	public AChickenMekanismSteelEntity(EntityType<AChickenMekanismSteelEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Steel Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.STEEL_NUGGET.get()));
	}
