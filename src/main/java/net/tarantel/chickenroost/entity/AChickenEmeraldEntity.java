...
public class AChickenEmeraldEntity extends Chicken {
	public AChickenEmeraldEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_EMERALD.get(), world);
	}

	public AChickenEmeraldEntity(EntityType<AChickenEmeraldEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Emerald Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.EMERALD_NUGGET.get()));
	}
