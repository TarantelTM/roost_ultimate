...
public class AChickenGranitEntity extends Chicken {
	public AChickenGranitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_GRANIT.get(), world);
	}

	public AChickenGranitEntity(EntityType<AChickenGranitEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Granit Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.GRANITE));
	}
