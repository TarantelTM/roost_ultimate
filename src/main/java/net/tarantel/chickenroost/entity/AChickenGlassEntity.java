...
public class AChickenGlassEntity extends Chicken {
	public AChickenGlassEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_GLASS.get(), world);
	}

	public AChickenGlassEntity(EntityType<AChickenGlassEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Glass Chicken"));
