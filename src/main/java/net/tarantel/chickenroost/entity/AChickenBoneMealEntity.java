...
public class AChickenBoneMealEntity extends Chicken {
	public AChickenBoneMealEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_BONE_MEAL.get(), world);
	}

	public AChickenBoneMealEntity(EntityType<AChickenBoneMealEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Bone Meal Chicken"));
