...
public class AChickenNautilusShellEntity extends Chicken {
	public AChickenNautilusShellEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_NAUTILUS_SHELL.get(), world);
	}

	public AChickenNautilusShellEntity(EntityType<AChickenNautilusShellEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Nautilus Shell Chicken"));
