...
public class AChickenVibraniumEntity extends Chicken {
	public AChickenVibraniumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_VIBRANIUM.get(), world);
	}
	...
	public AChickenVibraniumEntity(EntityType<AChickenVibraniumEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Vibranium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.VIBRANIUM.get()));
	}
