...
public class AChickenGravelEntity extends Chicken {
	public AChickenGravelEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_GRAVEL.get(), world);
	}

	public AChickenGravelEntity(EntityType<AChickenGravelEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Gravel Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.GRAVEL));
	}
