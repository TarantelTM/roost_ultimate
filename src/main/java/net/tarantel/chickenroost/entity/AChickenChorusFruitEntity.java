...
public class AChickenChorusFruitEntity extends Chicken {
	public AChickenChorusFruitEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_CHORUS_FRUIT.get(), world);
	}

	public AChickenChorusFruitEntity(EntityType<AChickenChorusFruitEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Chorus Fruit Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Items.CHORUS_FRUIT));
	}
