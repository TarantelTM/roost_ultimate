...
public class AChickenspidereyeEntity extends Chicken {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER)
				.add(new MobSpawnSettings.SpawnerData(ChickenRoostModEntities.A_CHICKENSPIDEREYE.get(), 10, 1, 2));
	}

	public AChickenspidereyeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKENSPIDEREYE.get(), world);
	}
	...
	public AChickenspidereyeEntity(EntityType<AChickenspidereyeEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Spider Eye Chicken"));
	...
	public static void init() {
		SpawnPlacements.register(ChickenRoostModEntities.A_CHICKENSPIDEREYE.get(), SpawnPlacements.Type.ON_GROUND,
