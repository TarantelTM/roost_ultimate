...
public class AChickentintedglassEntity extends Chicken {
	public AChickentintedglassEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKENTINTEDGLASS.get(), world);
	}

	public AChickentintedglassEntity(EntityType<AChickentintedglassEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Tinted Glass Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Blocks.TINTED_GLASS));
	}
