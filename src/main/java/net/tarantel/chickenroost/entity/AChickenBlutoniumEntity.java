...
public class AChickenBlutoniumEntity extends Chicken {
	public AChickenBlutoniumEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_BLUTONIUM.get(), world);
	}
	...
	public AChickenBlutoniumEntity(EntityType<AChickenBlutoniumEntity> type, Level world) {
		...
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Blutonium Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.BLUTONIUM_NUGGET.get()));
	}
