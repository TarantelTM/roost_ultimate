...
public class AChickenEnderPearlEntity extends Chicken {
	public AChickenEnderPearlEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_ENDER_PEARL.get(), world);
	}

	public AChickenEnderPearlEntity(EntityType<AChickenEnderPearlEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Ender Pearl Chicken"));
