...
public class AChickenRedstoneEntity extends Chicken {
	public AChickenRedstoneEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_REDSTONE.get(), world);
	}

	public AChickenRedstoneEntity(EntityType<AChickenRedstoneEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Redstone Chicken"));
