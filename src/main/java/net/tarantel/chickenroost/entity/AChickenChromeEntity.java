...
public class AChickenChromeEntity extends Chicken {
	public AChickenChromeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_CHROME.get(), world);
	}

	public AChickenChromeEntity(EntityType<AChickenChromeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Chrome Chicken"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ChickenRoostModItems.CHROME.get()));
	}
