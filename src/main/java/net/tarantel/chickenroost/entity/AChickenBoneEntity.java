...
public class AChickenBoneEntity extends Chicken {
	public AChickenBoneEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_BONE.get(), world);
	}

	public AChickenBoneEntity(EntityType<AChickenBoneEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Bone Chicken"));
