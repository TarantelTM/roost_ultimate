...
public class AChickenCoalEntity extends Chicken {
	public AChickenCoalEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ChickenRoostModEntities.A_CHICKEN_COAL.get(), world);
	}

	public AChickenCoalEntity(EntityType<AChickenCoalEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setCustomName(new TextComponent("Coal Chicken"));
