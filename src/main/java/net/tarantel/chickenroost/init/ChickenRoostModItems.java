...
import net.tarantel.chickenroost.item.RefinedObsidianNuggetItem;
import net.tarantel.chickenroost.item.RefinedIronNuggetItem;
import net.tarantel.chickenroost.item.RefinedGlowstoneNuggetItem;
...
import net.tarantel.chickenroost.item.MyinstakillparticlesItem;
import net.tarantel.chickenroost.item.MycheeseItem;
...
import net.tarantel.chickenroost.item.InvisibleitemdItem;
...
import net.tarantel.chickenroost.item.FasfasfaItem;
...
import net.tarantel.chickenroost.item.EChickenMekanismRefinedObsiItem;
import net.tarantel.chickenroost.item.EChickenMekanismRefinedGlowstoneItem;
...
public class ChickenRoostModItems {
	...
	public static final RegistryObject<Item> ROOST = block(ChickenRoostModBlocks.ROOST, null);
	public static final RegistryObject<Item> CHICKEN_STICK = REGISTRY.register("chicken_stick", () -> new ChickenStickItem());
	public static final RegistryObject<Item> A_CHICKEN_COBBLE = REGISTRY.register("a_chicken_cobble_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_COBBLE, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_FLINT = REGISTRY.register("a_chicken_flint_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_FLINT, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_SAND = REGISTRY.register("a_chicken_sand_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_SAND, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_GRAVEL = REGISTRY.register("a_chicken_gravel_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_GRAVEL, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_GRANIT = REGISTRY.register("a_chicken_granit_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_GRANIT, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_ANDERSITE = REGISTRY.register("a_chicken_andersite_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_ANDERSITE, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_COPPER = REGISTRY.register("a_chicken_copper_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_COPPER, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_IRON = REGISTRY.register("a_chicken_iron_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_IRON, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_REDSTONE = REGISTRY.register("a_chicken_redstone_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_REDSTONE, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_LAPIS = REGISTRY.register("a_chicken_lapis_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_LAPIS, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_DIAMOND = REGISTRY.register("a_chicken_diamond_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_DIAMOND, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_OBSIDIAN = REGISTRY.register("a_chicken_obsidian_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_OBSIDIAN, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_GOLD = REGISTRY.register("a_chicken_gold_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_GOLD, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_SLIME = REGISTRY.register("a_chicken_slime_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_SLIME, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_BIRCHWOOD = REGISTRY.register("a_chicken_birchwood_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_BIRCHWOOD, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_OAKWOOD = REGISTRY.register("a_chicken_oakwood_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_OAKWOOD, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> E_CHICKEN_COBBLE = REGISTRY.register("e_chicken_cobble", () -> new EChickenCobbleItem());
	public static final RegistryObject<Item> E_CHICKEN_FLINT = REGISTRY.register("e_chicken_flint", () -> new EChickenFlintItem());
	public static final RegistryObject<Item> E_CHICKEN_SAND = REGISTRY.register("e_chicken_sand", () -> new EChickenSandItem());
	public static final RegistryObject<Item> E_CHICKEN_GRAVEL = REGISTRY.register("e_chicken_gravel", () -> new EChickenGravelItem());
	public static final RegistryObject<Item> E_CHICKEN_GRANIT = REGISTRY.register("e_chicken_granit", () -> new EChickenGranitItem());
	public static final RegistryObject<Item> E_CHICKEN_ANDESITE = REGISTRY.register("e_chicken_andesite", () -> new EChickenAndesiteItem());
	public static final RegistryObject<Item> E_CHICKEN_COPPER = REGISTRY.register("e_chicken_copper", () -> new EChickenCopperItem());
	public static final RegistryObject<Item> E_CHICKEN_IRON = REGISTRY.register("e_chicken_iron", () -> new EChickenIronItem());
	public static final RegistryObject<Item> E_CHICKEN_REDSTONE = REGISTRY.register("e_chicken_redstone", () -> new EChickenRedstoneItem());
	public static final RegistryObject<Item> E_CHICKEN_LAPIS = REGISTRY.register("e_chicken_lapis", () -> new EChickenLapisItem());
	public static final RegistryObject<Item> E_CHICKEN_DIAMOND = REGISTRY.register("e_chicken_diamond", () -> new EChickenDiamondItem());
	public static final RegistryObject<Item> E_CHICKEN_OBSIDIAN = REGISTRY.register("e_chicken_obsidian", () -> new EChickenObsidianItem());
	public static final RegistryObject<Item> E_CHICKEN_GOLD = REGISTRY.register("e_chicken_gold", () -> new EChickenGoldItem());
	public static final RegistryObject<Item> E_CHICKEN_SLIME = REGISTRY.register("e_chicken_slime", () -> new EChickenSlimeItem());
	public static final RegistryObject<Item> E_CHICKEN_BIRCHWOOD = REGISTRY.register("e_chicken_birchwood", () -> new EChickenBirchwoodItem());
	public static final RegistryObject<Item> E_CHICKEN_OAKWOOD = REGISTRY.register("e_chicken_oakwood", () -> new EChickenOakwoodItem());
	...
	public static final RegistryObject<Item> ROOSTBOXWITHCHICKEN = block(ChickenRoostModBlocks.ROOSTBOXWITHCHICKEN, null);
	public static final RegistryObject<Item> ROOST_CHICKEN_COBBLE = block(ChickenRoostModBlocks.ROOST_CHICKEN_COBBLE, null);
	public static final RegistryObject<Item> ROOST_CHICKEN_FLINT = block(ChickenRoostModBlocks.ROOST_CHICKEN_FLINT, null);
	public static final RegistryObject<Item> A_CHICKEN_OSMIUM = REGISTRY.register("a_chicken_osmium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_OSMIUM, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> E_OSMIUM_CHICKEN = REGISTRY.register("e_osmium_chicken", () -> new EOsmiumChickenItem());
	public static final RegistryObject<Item> E_CHICKEN_CERTUSQ = REGISTRY.register("e_chicken_certusq", () -> new EChickenCertusqItem());
	public static final RegistryObject<Item> E_CHICKEN_MEKANISM_TIN = REGISTRY.register("e_chicken_mekanism_tin",
			() -> new EChickenMekanismTinItem());
	public static final RegistryObject<Item> E_CHICKEN_MEKANISM_REFINED_OBSI = REGISTRY.register("e_chicken_mekanism_refined_obsi",
			() -> new EChickenMekanismRefinedObsiItem());
	public static final RegistryObject<Item> E_CHICKEN_MEKANISM_BRONZE = REGISTRY.register("e_chicken_mekanism_bronze",
			() -> new EChickenMekanismBronzeItem());
	public static final RegistryObject<Item> E_CHICKEN_MEKANISM_REFINED_GLOWSTONE = REGISTRY.register("e_chicken_mekanism_refined_glowstone",
			() -> new EChickenMekanismRefinedGlowstoneItem());
	public static final RegistryObject<Item> E_CHICKEN_MEKANISM_STEEL = REGISTRY.register("e_chicken_mekanism_steel",
			() -> new EChickenMekanismSteelItem());
	public static final RegistryObject<Item> E_CHICKEN_MEKANISM_URANIUM = REGISTRY.register("e_chicken_mekanism_uranium",
			() -> new EChickenMekanismUraniumItem());
	public static final RegistryObject<Item> E_CHICKEN_MEKANISM_LEAD = REGISTRY.register("e_chicken_mekanism_lead",
			() -> new EChickenMekanismLeadItem());
	public static final RegistryObject<Item> E_CHICKEN_MEKANISM_BIO_FUEL = REGISTRY.register("e_chicken_mekanism_bio_fuel",
			() -> new EChickenMekanismBioFuelItem());
	public static final RegistryObject<Item> E_CHICKEN_AE_SILICON = REGISTRY.register("e_chicken_ae_silicon", () -> new EChickenAESiliconItem());
	public static final RegistryObject<Item> E_CHICKEN_AE_FLUIX_CRYSTAL = REGISTRY.register("e_chicken_ae_fluix_crystal",
			() -> new EChickenAEFluixCrystalItem());
	public static final RegistryObject<Item> E_CHICKEN_AE_CHARGED_CERTUS = REGISTRY.register("e_chicken_ae_charged_certus",
			() -> new EChickenAEChargedCertusItem());
	public static final RegistryObject<Item> E_CHICKEN_BOTANIA_MANASTEEL = REGISTRY.register("e_chicken_botania_manasteel",
			() -> new EChickenBotaniaManasteelItem());
	public static final RegistryObject<Item> E_CHICKEN_BOTANIA_TERRASTEEL = REGISTRY.register("e_chicken_botania_terrasteel",
			() -> new EChickenBotaniaTerrasteelItem());
	public static final RegistryObject<Item> E_CHICKEN_BOTANIA_ELEMENTIUM = REGISTRY.register("e_chicken_botania_elementium",
			() -> new EChickenBotaniaElementiumItem());
	public static final RegistryObject<Item> E_CHICKEN_BOTANIA_LIVINGROCK = REGISTRY.register("e_chicken_botania_livingrock",
			() -> new EChickenBotaniaLivingrockItem());
	public static final RegistryObject<Item> E_CHICKEN_BOTANIA_LIVINGWOOD = REGISTRY.register("e_chicken_botania_livingwood",
			() -> new EChickenBotaniaLivingwoodItem());
	public static final RegistryObject<Item> E_CHICKEN_CRIMSTON_STEM = REGISTRY.register("e_chicken_crimston_stem",
			() -> new EChickenCrimstonStemItem());
	public static final RegistryObject<Item> E_CHICKEN_WARPED_STEM = REGISTRY.register("e_chicken_warped_stem", () -> new EChickenWarpedStemItem());
	public static final RegistryObject<Item> E_CHICKEN_SPRUCEWOOD = REGISTRY.register("e_chicken_sprucewood", () -> new EChickenSprucewoodItem());
	public static final RegistryObject<Item> E_CHICKEN_GLASS = REGISTRY.register("e_chicken_glass", () -> new EChickenGlassItem());
	public static final RegistryObject<Item> E_CHICKEN_WOOL = REGISTRY.register("e_chicken_wool", () -> new EChickenWoolItem());
	public static final RegistryObject<Item> E_CHICKEN_SOUL_SAND = REGISTRY.register("e_chicken_soul_sand", () -> new EChickenSoulSandItem());
	public static final RegistryObject<Item> E_CHICKEN_NETHERRACK = REGISTRY.register("e_chicken_netherrack", () -> new EChickenNetherrackItem());
	public static final RegistryObject<Item> E_CHICKEN_SOUL_SOIL = REGISTRY.register("e_chicken_soul_soil", () -> new EChickenSoulSoilItem());
	public static final RegistryObject<Item> E_CHICKEN_BASALT = REGISTRY.register("e_chicken_basalt", () -> new EChickenBasaltItem());
	public static final RegistryObject<Item> E_CHICKEN_INK = REGISTRY.register("e_chicken_ink", () -> new EChickenInkItem());
	public static final RegistryObject<Item> E_CHICKEN_PAPER = REGISTRY.register("e_chicken_paper", () -> new EChickenPaperItem());
	public static final RegistryObject<Item> E_CHICKEN_CLAY = REGISTRY.register("e_chicken_clay", () -> new EChickenClayItem());
	public static final RegistryObject<Item> E_CHICKEN_QUARTZ = REGISTRY.register("e_chicken_quartz", () -> new EChickenQuartzItem());
	public static final RegistryObject<Item> E_CHICKEN_AMETHYST_SHARD = REGISTRY.register("e_chicken_amethyst_shard",
			() -> new EChickenAmethystShardItem());
	public static final RegistryObject<Item> E_CHICKEN_EMERALD = REGISTRY.register("e_chicken_emerald", () -> new EChickenEmeraldItem());
	public static final RegistryObject<Item> E_CHICKEN_TNT = REGISTRY.register("e_chicken_tnt", () -> new EChickenTNTItem());
	public static final RegistryObject<Item> E_CHICKEN_DIORITE = REGISTRY.register("e_chicken_diorite", () -> new EChickenDioriteItem());
	public static final RegistryObject<Item> E_CHICKEN_STONE = REGISTRY.register("e_chicken_stone", () -> new EChickenStoneItem());
	public static final RegistryObject<Item> E_CHICKEN_NETHER_STAR = REGISTRY.register("e_chicken_nether_star", () -> new EChickenNetherStarItem());
	public static final RegistryObject<Item> E_CHICKEN_NETHER_WART = REGISTRY.register("e_chicken_nether_wart", () -> new EChickenNetherWartItem());
	public static final RegistryObject<Item> E_CHICKEN_ENDER_EYE = REGISTRY.register("e_chicken_ender_eye", () -> new EChickenEnderEyeItem());
	public static final RegistryObject<Item> E_CHICKEN_GLOWSTONE = REGISTRY.register("e_chicken_glowstone", () -> new EChickenGlowstoneItem());
	public static final RegistryObject<Item> E_CHICKEN_BLAZE_ROD = REGISTRY.register("e_chicken_blaze_rod", () -> new EChickenBlazeRodItem());
	public static final RegistryObject<Item> E_CHICKEN_SUGAR = REGISTRY.register("e_chicken_sugar", () -> new EChickenSugarItem());
	public static final RegistryObject<Item> E_CHICKEN_BONE_MEAL = REGISTRY.register("e_chicken_bone_meal", () -> new EChickenBoneMealItem());
	public static final RegistryObject<Item> E_CHICKEN_ENDER_PEARL = REGISTRY.register("e_chicken_ender_pearl", () -> new EChickenEnderPearlItem());
	public static final RegistryObject<Item> E_CHICKEN_BONE = REGISTRY.register("e_chicken_bone", () -> new EChickenBoneItem());
	public static final RegistryObject<Item> E_CHICKEN_DARK_OAK = REGISTRY.register("e_chicken_dark_oak", () -> new EChickenDarkOakItem());
	public static final RegistryObject<Item> E_CHICKEN_ACACIAWOOD = REGISTRY.register("e_chicken_acaciawood", () -> new EChickenAcaciawoodItem());
	public static final RegistryObject<Item> E_CHICKEN_JUNGLEWOOD = REGISTRY.register("e_chicken_junglewood", () -> new EChickenJunglewoodItem());
	public static final RegistryObject<Item> E_CHICKEN_NAUTILUS_SHELL = REGISTRY.register("e_chicken_nautilus_shell",
			() -> new EChickenNautilusShellItem());
	public static final RegistryObject<Item> E_CHICKEN_HONEYCOMB = REGISTRY.register("e_chicken_honeycomb", () -> new EChickenHoneycombItem());
	public static final RegistryObject<Item> E_CHICKEN_RABBIT_HIDE = REGISTRY.register("e_chicken_rabbit_hide", () -> new EChickenRabbitHideItem());
	public static final RegistryObject<Item> E_CHICKEN_PRISMARINE_SHARD = REGISTRY.register("e_chicken_prismarine_shard",
			() -> new EChickenPrismarineShardItem());
	public static final RegistryObject<Item> E_CHICKEN_NETHER_BRICK = REGISTRY.register("e_chicken_nether_brick",
			() -> new EChickenNetherBrickItem());
	public static final RegistryObject<Item> E_CHICKEN_CHORUS_FRUIT = REGISTRY.register("e_chicken_chorus_fruit",
			() -> new EChickenChorusFruitItem());
	public static final RegistryObject<Item> E_CHICKEN_COAL = REGISTRY.register("e_chicken_coal", () -> new EChickenCoalItem());
	public static final RegistryObject<Item> E_CHICKEN_CHAR_COAL = REGISTRY.register("e_chicken_char_coal", () -> new EChickenCharCoalItem());
	public static final RegistryObject<Item> A_CHICKEN_MEKANISM_TIN = REGISTRY.register("a_chicken_mekanism_tin_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_MEKANISM_TIN, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_MEKANISM_REFINED_OBSI = REGISTRY.register("a_chicken_mekanism_refined_obsi_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_MEKANISM_REFINED_OBSI, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_MEKANISM_BRONZE = REGISTRY.register("a_chicken_mekanism_bronze_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_MEKANISM_BRONZE, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_MEKANISM_REFINED_GLOWSTONE = REGISTRY.register(
			"a_chicken_mekanism_refined_glowstone_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_MEKANISM_REFINED_GLOWSTONE, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_MEKANISM_STEEL = REGISTRY.register("a_chicken_mekanism_steel_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_MEKANISM_STEEL, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_MEKANISM_URANIUM = REGISTRY.register("a_chicken_mekanism_uranium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_MEKANISM_URANIUM, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_MEKANISM_LEAD = REGISTRY.register("a_chicken_mekanism_lead_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_MEKANISM_LEAD, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_MEKANISM_BIO_FUEL = REGISTRY.register("a_chicken_mekanism_bio_fuel_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_MEKANISM_BIO_FUEL, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_AE_SILICON = REGISTRY.register("a_chicken_ae_silicon_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_AE_SILICON, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_AE_CERTUS_QUARTZ = REGISTRY.register("a_chicken_ae_certus_quartz_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_AE_CERTUS_QUARTZ, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_AE_FLUIX_CRYSTAL = REGISTRY.register("a_chicken_ae_fluix_crystal_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_AE_FLUIX_CRYSTAL, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_AE_CHARGED_CERTUS = REGISTRY.register("a_chicken_ae_charged_certus_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_AE_CHARGED_CERTUS, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_BOTANIA_MANASTEEL = REGISTRY.register("a_chicken_botania_manasteel_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_BOTANIA_MANASTEEL, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_BOTANIA_TERRASTEEL = REGISTRY.register("a_chicken_botania_terrasteel_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_BOTANIA_TERRASTEEL, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_BOTANIA_ELEMENTIUM = REGISTRY.register("a_chicken_botania_elementium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_BOTANIA_ELEMENTIUM, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_BOTANIA_LIVINGROCK = REGISTRY.register("a_chicken_botania_livingrock_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_BOTANIA_LIVINGROCK, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	...
	public static final RegistryObject<Item> A_CHICKEN_PRISMARINE_SHARD = REGISTRY.register("a_chicken_prismarine_shard_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_PRISMARINE_SHARD, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_NETHER_BRICK = REGISTRY.register("a_chicken_nether_brick_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_NETHER_BRICK, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_CHORUS_FRUIT = REGISTRY.register("a_chicken_chorus_fruit_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_CHORUS_FRUIT, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_COAL = REGISTRY.register("a_chicken_coal_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_COAL, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_CHAR_COAL = REGISTRY.register("a_chicken_char_coal_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_CHAR_COAL, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> ROOST_CHICKEN_OSMIUM = block(ChickenRoostModBlocks.ROOST_CHICKEN_OSMIUM, null);
	public static final RegistryObject<Item> ALPHA_ROOST_CONTAINER = block(ChickenRoostModBlocks.ALPHA_ROOST_CONTAINER,
			ChickenRoostModTabs.TAB_CHICKEN_ROOST);
	public static final RegistryObject<Item> CHICKEN_NUGGET = REGISTRY.register("chicken_nugget", () -> new ChickenNuggetItem());
	public static final RegistryObject<Item> COOKEDNUGGET = REGISTRY.register("cookednugget", () -> new CookednuggetItem());
	public static final RegistryObject<Item> CHICKENCHICKEN = REGISTRY.register("chickenchicken", () -> new ChickenchickenItem());
	...
	public static final RegistryObject<Item> A_CHICKEN_LEATHER = REGISTRY.register("a_chicken_leather_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_LEATHER, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> E_CHICKEN_LEATHER = REGISTRY.register("e_chicken_leather", () -> new EChickenLeatherItem());
	public static final RegistryObject<Item> ADAMANTIUM = REGISTRY.register("adamantium", () -> new AdamantiumItem());
	...
	public static final RegistryObject<Item> CHROME = REGISTRY.register("chrome", () -> new ChromeItem());
	public static final RegistryObject<Item> DIAMONDNUGGET = REGISTRY.register("diamondnugget", () -> new DiamondnuggetItem());
	public static final RegistryObject<Item> ELECTRUM = REGISTRY.register("electrum", () -> new ElectrumItem());
	public static final RegistryObject<Item> EMERALD_NUGGET = REGISTRY.register("emerald_nugget", () -> new EmeraldNuggetItem());
	public static final RegistryObject<Item> HOT_TUNGSTENSTEEL_NUGGET = REGISTRY.register("hot_tungstensteel_nugget",
			() -> new HotTungstensteelNuggetItem());
	public static final RegistryObject<Item> INVAR_NUGGET = REGISTRY.register("invar_nugget", () -> new InvarNuggetItem());
	public static final RegistryObject<Item> IRIDIUM_NUGGET = REGISTRY.register("iridium_nugget", () -> new IridiumNuggetItem());
	...
	public static final RegistryObject<Item> REFINED_IRON_NUGGET = REGISTRY.register("refined_iron_nugget", () -> new RefinedIronNuggetItem());
	...
	public static final RegistryObject<Item> TUNGSTENSTEEL_NUGGET = REGISTRY.register("tungstensteel_nugget", () -> new TungstensteelNuggetItem());
	...
	public static final RegistryObject<Item> REFINED_GLOWSTONE_NUGGET = REGISTRY.register("refined_glowstone_nugget",
			() -> new RefinedGlowstoneNuggetItem());
	public static final RegistryObject<Item> REFINED_OBSIDIAN_NUGGET = REGISTRY.register("refined_obsidian_nugget",
			() -> new RefinedObsidianNuggetItem());
	public static final RegistryObject<Item> URANIUM_NUGGET = REGISTRY.register("uranium_nugget", () -> new UraniumNuggetItem());
	public static final RegistryObject<Item> YELLORIUM_NUGGET = REGISTRY.register("yellorium_nugget", () -> new YelloriumNuggetItem());
	public static final RegistryObject<Item> BLUTONIUM_NUGGET = REGISTRY.register("blutonium_nugget", () -> new BlutoniumNuggetItem());
	public static final RegistryObject<Item> ALLTHEMODIUM = REGISTRY.register("allthemodium", () -> new AllthemodiumItem());
	public static final RegistryObject<Item> VIBRANIUM = REGISTRY.register("vibranium", () -> new VibraniumItem());
	public static final RegistryObject<Item> TERRASTEEL_NUGGET = REGISTRY.register("terrasteel_nugget", () -> new TerrasteelNuggetItem());
	public static final RegistryObject<Item> MANASTEEL_NUGGET = REGISTRY.register("manasteel_nugget", () -> new ManasteelNuggetItem());
	public static final RegistryObject<Item> ELEMENTIUM_NUGGET = REGISTRY.register("elementium_nugget", () -> new ElementiumNuggetItem());
	public static final RegistryObject<Item> UNOBTAINIUM_NUGGET = REGISTRY.register("unobtainium_nugget", () -> new UnobtainiumNuggetItem());
	public static final RegistryObject<Item> NETHERSTARSHARD = REGISTRY.register("netherstarshard", () -> new NetherstarshardItem());
	public static final RegistryObject<Item> E_CHICKEN_STRING = REGISTRY.register("e_chicken_string", () -> new EChickenStringItem());
	public static final RegistryObject<Item> ECHICKENFEATHER = REGISTRY.register("echickenfeather", () -> new EchickenfeatherItem());
	public static final RegistryObject<Item> ECHICKENSNOW = REGISTRY.register("echickensnow", () -> new EchickensnowItem());
	public static final RegistryObject<Item> ECHICKENAPPLE = REGISTRY.register("echickenapple", () -> new EchickenappleItem());
	public static final RegistryObject<Item> ECHICKENSPONGE = REGISTRY.register("echickensponge", () -> new EchickenspongeItem());
	public static final RegistryObject<Item> E_CHICKEN_MELON = REGISTRY.register("e_chicken_melon", () -> new EChickenMelonItem());
	public static final RegistryObject<Item> E_CHICKEN_MAGMACREAM = REGISTRY.register("e_chicken_magmacream", () -> new EChickenMagmacreamItem());
	public static final RegistryObject<Item> E_CHICKENBLAZEPOWDER = REGISTRY.register("e_chickenblazepowder", () -> new EChickenblazepowderItem());
	public static final RegistryObject<Item> E_CHICKENGLOWBERRIES = REGISTRY.register("e_chickenglowberries", () -> new EChickenglowberriesItem());
	...
	public static final RegistryObject<Item> E_CHICKEN_SWEETBERRIES = REGISTRY.register("e_chicken_sweetberries",
			() -> new EChickenSweetberriesItem());
	public static final RegistryObject<Item> E_CHICKEN_TINTEDGLASS = REGISTRY.register("e_chicken_tintedglass", () -> new EChickenTintedglassItem());
	public static final RegistryObject<Item> E_CHICKEN_NETHERITE = REGISTRY.register("e_chicken_netherite", () -> new EChickenNetheriteItem());
	public static final RegistryObject<Item> E_CHICKENBEETROOT = REGISTRY.register("e_chickenbeetroot", () -> new EChickenbeetrootItem());
	public static final RegistryObject<Item> E_CHICKEN_SPIDEREYE = REGISTRY.register("e_chicken_spidereye", () -> new EChickenSpidereyeItem());
	public static final RegistryObject<Item> E_CHICKENCARROT = REGISTRY.register("e_chickencarrot", () -> new EChickencarrotItem());
	public static final RegistryObject<Item> E_CHICKEN_ROTTEN = REGISTRY.register("e_chicken_rotten", () -> new EChickenRottenItem());
	public static final RegistryObject<Item> E_CHICKEN_GHASTTEAR = REGISTRY.register("e_chicken_ghasttear", () -> new EChickenGhasttearItem());
	public static final RegistryObject<Item> A_CHICKEN_STRING = REGISTRY.register("a_chicken_string_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_STRING, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_FEATHER = REGISTRY.register("a_chicken_feather_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_FEATHER, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENSNOW = REGISTRY.register("a_chickensnow_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENSNOW, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENAPPLE = REGISTRY.register("a_chickenapple_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENAPPLE, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENSPONGE = REGISTRY.register("a_chickensponge_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENSPONGE, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENMELON = REGISTRY.register("a_chickenmelon_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENMELON, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENMAGMACREAM = REGISTRY.register("a_chickenmagmacream_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENMAGMACREAM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENBLAZEPOWDER = REGISTRY.register("a_chickenblazepowder_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENBLAZEPOWDER, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENGLOWBERRIES = REGISTRY.register("a_chickenglowberries_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENGLOWBERRIES, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENSWEETBERRIES = REGISTRY.register("a_chickensweetberries_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENSWEETBERRIES, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENTINTEDGLASS = REGISTRY.register("a_chickentintedglass_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENTINTEDGLASS, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENNETHERITE = REGISTRY.register("a_chickennetherite_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENNETHERITE, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENBEETROOT = REGISTRY.register("a_chickenbeetroot_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENBEETROOT, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENSPIDEREYE = REGISTRY.register("a_chickenspidereye_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENSPIDEREYE, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENCARROT = REGISTRY.register("a_chickencarrot_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENCARROT, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENROTTEN = REGISTRY.register("a_chickenrotten_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENROTTEN, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKENGHASTTEAR = REGISTRY.register("a_chickenghasttear_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKENGHASTTEAR, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> E_CHICKEN_ZINC = REGISTRY.register("e_chicken_zinc", () -> new EChickenZincItem());
	public static final RegistryObject<Item> E_CHICKEN_ALUMINIUM = REGISTRY.register("e_chicken_aluminium", () -> new EChickenAluminiumItem());
	public static final RegistryObject<Item> E_CHICKEN_SILVER = REGISTRY.register("e_chicken_silver", () -> new EChickenSilverItem());
	public static final RegistryObject<Item> E_CHICKEN_NICKEL = REGISTRY.register("e_chicken_nickel", () -> new EChickenNickelItem());
	public static final RegistryObject<Item> E_CHICKEN_ADAMANTIUM = REGISTRY.register("e_chicken_adamantium", () -> new EChickenAdamantiumItem());
	public static final RegistryObject<Item> E_CHICKEN_BRASS = REGISTRY.register("e_chicken_brass", () -> new EChickenBrassItem());
	public static final RegistryObject<Item> E_CHICKEN_CHROME = REGISTRY.register("e_chicken_chrome", () -> new EChickenChromeItem());
	public static final RegistryObject<Item> E_CHICKEN_ELECTRUM = REGISTRY.register("e_chicken_electrum", () -> new EChickenElectrumItem());
	public static final RegistryObject<Item> E_CHICKEN_HOT_TUNGSTEN_STEEL = REGISTRY.register("e_chicken_hot_tungsten_steel",
			() -> new EChickenHotTungstenSteelItem());
	public static final RegistryObject<Item> E_CHICKEN_INVAR = REGISTRY.register("e_chicken_invar", () -> new EChickenInvarItem());
	public static final RegistryObject<Item> E_CHICKEN_IRIDIUM = REGISTRY.register("e_chicken_iridium", () -> new EChickenIridiumItem());
	public static final RegistryObject<Item> E_CHICKEN_PLATINUM = REGISTRY.register("e_chicken_platinum", () -> new EChickenPlatinumItem());
	public static final RegistryObject<Item> E_CHICKEN_REFINED_IRON = REGISTRY.register("e_chicken_refined_iron",
			() -> new EChickenRefinedIronItem());
	public static final RegistryObject<Item> E_CHICKEN_TITANIUM = REGISTRY.register("e_chicken_titanium", () -> new EChickenTitaniumItem());
	public static final RegistryObject<Item> E_CHICKEN_TUNGSTEN = REGISTRY.register("e_chicken_tungsten", () -> new EChickenTungstenItem());
	public static final RegistryObject<Item> E_CHICKEN_TUNGSTENSTEEL = REGISTRY.register("e_chicken_tungstensteel",
			() -> new EChickenTungstensteelItem());
	public static final RegistryObject<Item> E_CHICKEN_YELLORIUM = REGISTRY.register("e_chicken_yellorium", () -> new EChickenYelloriumItem());
	public static final RegistryObject<Item> E_CHICKEN_BLUTONIUM = REGISTRY.register("e_chicken_blutonium", () -> new EChickenBlutoniumItem());
	public static final RegistryObject<Item> E_CHICKEN_ALLTHEMODIUM = REGISTRY.register("e_chicken_allthemodium",
			() -> new EChickenAllthemodiumItem());
	public static final RegistryObject<Item> E_CHICKEN_VIBRANIUM = REGISTRY.register("e_chicken_vibranium", () -> new EChickenVibraniumItem());
	public static final RegistryObject<Item> E_CHICKEN_UNOBTAINIUM = REGISTRY.register("e_chicken_unobtainium", () -> new EChickenUnobtainiumItem());
	public static final RegistryObject<Item> A_CHICKEN_ALUMINIUM = REGISTRY.register("a_chicken_aluminium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_ALUMINIUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_ZINC = REGISTRY.register("a_chicken_zinc_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_ZINC, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_SILVER = REGISTRY.register("a_chicken_silver_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_SILVER, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_NICKEL = REGISTRY.register("a_chicken_nickel_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_NICKEL, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_ADAMANTIUM = REGISTRY.register("a_chicken_adamantium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_ADAMANTIUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_BRASS = REGISTRY.register("a_chicken_brass_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_BRASS, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_CHROME = REGISTRY.register("a_chicken_chrome_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_CHROME, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_ELECTRUM = REGISTRY.register("a_chicken_electrum_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_ELECTRUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_INVAR = REGISTRY.register("a_chicken_invar_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_INVAR, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_IRIDIUM = REGISTRY.register("a_chicken_iridium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_IRIDIUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_PLATINUM = REGISTRY.register("a_chicken_platinum_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_PLATINUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_REFINEDIRON = REGISTRY.register("a_chicken_refinediron_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_REFINEDIRON, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_TITANIUM = REGISTRY.register("a_chicken_titanium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_TITANIUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_TUNGSTEN = REGISTRY.register("a_chicken_tungsten_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_TUNGSTEN, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_TUNGSTENSTEEL = REGISTRY.register("a_chicken_tungstensteel_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_TUNGSTENSTEEL, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_YELLORIUM = REGISTRY.register("a_chicken_yellorium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_YELLORIUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_BLUTONIUM = REGISTRY.register("a_chicken_blutonium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_BLUTONIUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_ALLTHEMODIUM = REGISTRY.register("a_chicken_allthemodium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_ALLTHEMODIUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_VIBRANIUM = REGISTRY.register("a_chicken_vibranium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_VIBRANIUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_UNOBTAINIUM = REGISTRY.register("a_chicken_unobtainium_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_UNOBTAINIUM, -1, -1,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> A_CHICKEN_ENDSTONE = REGISTRY.register("a_chicken_endstone_spawn_egg",
			() -> new ForgeSpawnEggItem(ChickenRoostModEntities.A_CHICKEN_ENDSTONE, -3355444, -52429,
					new Item.Properties().tab(ChickenRoostModTabs.TAB_ROOST_EGGS)));
	public static final RegistryObject<Item> E_CHICKEN_ENDSTONE = REGISTRY.register("e_chicken_endstone", () -> new EChickenEndstoneItem());
	public static final RegistryObject<Item> GGDSGSGSDS = REGISTRY.register("ggdsgsgsds", () -> new GgdsgsgsdsItem());
	...
	public static final RegistryObject<Item> GGGGG = REGISTRY.register("ggggg", () -> new GggggItem());
	public static final RegistryObject<Item> MYINSTAKILLPARTICLES = REGISTRY.register("myinstakillparticles", () -> new MyinstakillparticlesItem());
	public static final RegistryObject<Item> FASFASFA = REGISTRY.register("fasfasfa", () -> new FasfasfaItem());
	public static final RegistryObject<Item> INVISIBLEITEMD = REGISTRY.register("invisibleitemd", () -> new InvisibleitemdItem());
	...
	public static final RegistryObject<Item> MYCHEESE = REGISTRY.register("mycheese", () -> new MycheeseItem());
	public static final RegistryObject<Item> CHEESEMAKER = block(ChickenRoostModBlocks.CHEESEMAKER, null);
	public static final RegistryObject<Item> CHICKEN_SCANNER = REGISTRY.register("chicken_scanner", () -> new ChickenScannerItem());
