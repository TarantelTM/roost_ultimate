...
public class ChickenChangerProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((new Object() {
		...
		}.getItemStack(world, new BlockPos(x, y, z), 0)).getItem() == (ItemStack.EMPTY).getItem()) {
			{
				...
				Property<?> _property = _bs.getBlock().getStateDefinition().getProperty("SkinNumber");
		...
		}.getItemStack(world, new BlockPos(x, y, z), 0)).getItem() == ChickenRoostModItems.E_CHICKEN_COBBLE.get()) {
			{
				int _value = 1;
				BlockPos _pos = new BlockPos((int) x, (int) y, (int) z);
				BlockState _bs = world.getBlockState(_pos);
