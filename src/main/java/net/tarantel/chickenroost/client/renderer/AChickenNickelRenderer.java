...
public class AChickenNickelRenderer extends MobRenderer<AChickenNickelEntity, ChickenModel<AChickenNickelEntity>> {
	...
	public ResourceLocation getTextureLocation(AChickenNickelEntity entity) {
		return new ResourceLocation("chicken_roost:textures/nickel_chicken.png");
	}
}
