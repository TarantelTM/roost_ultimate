...
public class AChickenOsmiumRenderer extends MobRenderer<AChickenOsmiumEntity, ChickenModel<AChickenOsmiumEntity>> {
	...
	public ResourceLocation getTextureLocation(AChickenOsmiumEntity entity) {
		return new ResourceLocation("chicken_roost:textures/osmium_chicken.png");
	}
}
