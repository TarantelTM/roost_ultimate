...
public class AChickenBotaniaManasteelRenderer extends MobRenderer<AChickenBotaniaManasteelEntity, ChickenModel<AChickenBotaniaManasteelEntity>> {
	...
	public ResourceLocation getTextureLocation(AChickenBotaniaManasteelEntity entity) {
		return new ResourceLocation("chicken_roost:textures/manasteel_chicken.png");
	}
}
