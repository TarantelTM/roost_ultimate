...
public class AChickensweetberriesRenderer extends MobRenderer<AChickensweetberriesEntity, ChickenModel<AChickensweetberriesEntity>> {
	...
	public ResourceLocation getTextureLocation(AChickensweetberriesEntity entity) {
		return new ResourceLocation("chicken_roost:textures/redstone_crystal_chicken.png");
	}
}
