...
public class AChickenCobbleRenderer extends MobRenderer<AChickenCobbleEntity, ChickenModel<AChickenCobbleEntity>> {
	...
	public ResourceLocation getTextureLocation(AChickenCobbleEntity entity) {
		return new ResourceLocation("chicken_roost:textures/better_cobblestone.png");
	}
}
