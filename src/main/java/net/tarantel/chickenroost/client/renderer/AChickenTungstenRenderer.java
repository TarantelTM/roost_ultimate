...
public class AChickenTungstenRenderer extends MobRenderer<AChickenTungstenEntity, ChickenModel<AChickenTungstenEntity>> {
	...
	public ResourceLocation getTextureLocation(AChickenTungstenEntity entity) {
		return new ResourceLocation("chicken_roost:textures/tungsten_chicken.png");
	}
}
