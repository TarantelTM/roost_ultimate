...
public class AChickenAndersiteRenderer extends MobRenderer<AChickenAndersiteEntity, ChickenModel<AChickenAndersiteEntity>> {
	public AChickenAndersiteRenderer(EntityRendererProvider.Context context) {
		super(context, new ChickenModel(context.bakeLayer(ModelLayers.CHICKEN)), 0.5f);
	}

	@Override
	public ResourceLocation getTextureLocation(AChickenAndersiteEntity entity) {
