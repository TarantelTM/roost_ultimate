...
public class EChickenAdamantiumItem extends Item {
	public EChickenAdamantiumItem() {
	...
	int roost_chickenxp = 0;
		...
		list.add(new TextComponent("\u00A71" + "Tier: " + "\u00A79" + "8"));
		list.add(new TextComponent((("\u00A7e") + "Level: " + "\u00A79" + ((roost_chickenlevel)) + "/" + (((int) ChickenRoostModVariables.maxlevel_tier_8)))));
		list.add(new TextComponent((("\u00A7a") + "XP: " + "\u00A79" + ((roost_chickenxp)) + "/" + (((int) ChickenRoostModVariables.xp_tier_8)))));
