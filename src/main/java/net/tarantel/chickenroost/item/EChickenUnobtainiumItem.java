...
public class EChickenUnobtainiumItem extends Item {
	public EChickenUnobtainiumItem() {
	...
	int roost_chickenxp = 0;
		...
		list.add(new TextComponent("\u00A71" + "Tier: " + "\u00A79" + "9"));
		list.add(new TextComponent((("\u00A7e") + "Level: " + "\u00A79" + ((roost_chickenlevel)) + "/" + (((int) ChickenRoostModVariables.maxlevel_tier_9)))));
		list.add(new TextComponent((("\u00A7a") + "XP: " + "\u00A79" + ((roost_chickenxp)) + "/" + (((int) ChickenRoostModVariables.xp_tier_9)))));
